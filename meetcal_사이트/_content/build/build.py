...
header.site .go{margin-left:auto;font-size:14px;font-weight:700;text-decoration:none;
  background:var(--acc);color:#fff;padding:8px 14px;border-radius:8px}
...
pre{background:#1a1e24;color:#e6ecf4;padding:16px 18px;border-radius:10px;overflow-x:auto;
  font-size:14px;line-height:1.7}
code{font-family:ui-monospace,Menlo,Consolas,monospace}
ul,ol{margin:0 0 18px;padding-left:22px}
li{margin-bottom:8px}
hr{border:0;border-top:1px solid var(--line);margin:40px 0}
.cta{margin:36px 0;padding:22px;border-radius:14px;border:1px solid #cfe0f5;
  background:linear-gradient(135deg,#f2f7fe,#fbfdff);text-align:center}
...
.cta a{display:inline-block;background:var(--acc);color:#fff;text-decoration:none;
...
/* 글 안 계산기 */
.calc{margin:32px 0;padding:24px 22px;border:1px solid #cfe0f5;border-radius:16px;
  background:linear-gradient(135deg,#f5f9ff,#fdfeff)}
...
.crow input{display:block;width:100%;margin-top:5px;padding:12px 10px;border:1px solid #cbd6e4;
  border-radius:9px;font-size:17px;font-family:inherit;text-align:center;background:#fff;color:var(--ink)}
.crow input:disabled{background:#eef1f5;color:#a8b0bd}
.cchk{display:flex;align-items:center;gap:8px;font-size:13.5px;color:var(--mut);margin-bottom:16px}
.calc button{width:100%;padding:14px;border:0;border-radius:10px;background:var(--acc);color:#fff;
  font-size:16px;font-weight:700;font-family:inherit;cursor:pointer}
.cout{margin-top:20px;padding-top:20px;border-top:1px solid #d9e5f3}
.cerr{font-size:14px;color:#c0392b}
...
.cgrid>div{background:#fff;border:1px solid #dce6f2;border-radius:10px;padding:11px 13px}
...
.cbars{background:#fff;border:1px solid #dce6f2;border-radius:10px;padding:14px}
.cad{margin-top:40px;padding-top:20px;border-top:1px dashed #cfdcec}
.lgen{display:flex;gap:8px;margin-bottom:16px}
.lgen button{flex:1;padding:11px;border:1px solid #cfdcec;border-radius:9px;background:#fff;
  font:inherit;font-size:14px;font-weight:700;color:var(--mut);cursor:pointer}
.lgen button.on{background:var(--acc);border-color:var(--acc);color:#fff}
...
.lrow input,.lrow select{width:100%;padding:11px 10px;border:1px solid #cfdcec;border-radius:9px;
...
.ltbl{display:table;width:100%;border-collapse:collapse;margin:14px 0 4px;font-size:14px;
  background:#fff;border:1px solid #dce6f2;border-radius:10px;overflow:hidden}
.ltbl th{width:34%;background:#eef4fb;font-size:12.5px;color:var(--mut);font-weight:700;
  padding:10px;text-align:left;border-bottom:0;white-space:nowrap}
.ltbl td{padding:10px;border-top:1px solid #eef2f7;border-bottom:0;font-weight:700;white-space:normal}
.ltag{display:inline-block;margin-left:6px;font-size:11.5px;font-weight:700;color:var(--acc);
  background:#eaf1fb;border-radius:5px;padding:2px 7px;vertical-align:1px}
...
.cadph{border:1px dashed #c3d3e6;border-radius:10px;background:#fbfdff;color:var(--dim);
  text-align:center;padding:34px 16px;font-size:13.5px;line-height:1.7}
.cadph span{font-size:12px;color:#a9b4c2}
.ctie{display:table;width:100%;border-collapse:collapse;margin:14px 0 4px;font-size:13.5px;background:#fff;
  border:1px solid #dce6f2;border-radius:10px;overflow:hidden}
.ctie th{background:#eef4fb;font-size:12px;color:var(--mut);font-weight:700;padding:8px 10px;text-align:left}
.ctie td{padding:9px 10px;border-top:1px solid #eef2f7;border-bottom:0;white-space:normal}
...
.cbt{flex:1;height:10px;background:#eef2f7;border-radius:5px;overflow:hidden}
...
.cgame{display:block;margin-top:16px;text-align:center;background:#1a1e24;color:#fff;
...
.card:hover{border-color:#c3cede}
